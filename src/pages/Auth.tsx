    ...
    <div className="min-h-screen bg-gradient-to-br from-festive-gold/10 to-festive-red/10 flex items-center justify-center p-4 relative">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {isLogin ? 'Sign in to your RakhiMart account' : 'Join RakhiMart today'}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <Button 
            ...
            variant="outline"
            className="w-full flex items-center justify-center gap-3 py-6 text-base font-medium border-2 hover:bg-gray-50"
          >
